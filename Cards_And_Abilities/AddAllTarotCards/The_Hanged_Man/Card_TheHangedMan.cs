	...
	public class Card_TheHangedMan
	{
		...
		public static DiskCardGame.CardInfo InitCard()
		{
			...
			UnityEngine.Texture2D defaultTexture =
				APIPlugin.CardUtils.LoadImageAndGetTexture("card_the_hanged_man.png");

			const string displayName = "The Hanged Man";
			const string desc = "The Hanged Man. Its dead weight will provide cover for other creatures.";
